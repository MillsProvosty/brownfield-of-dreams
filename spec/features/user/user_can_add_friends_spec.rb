...
describe 'As a user on my dashboard page' do
  it 'I see a button to add friends next to followers and followed users' do
    VCR.use_cassette('github_add_friend', record: :new_episodes) do
      ...
      user3 = create(
        :user_with_github,
        github_handle: 'm-mrcr',
        github_url: 'https://github.com/m-mrcr'
      )
  ...
  it "I get an error message when I add someone I'm already friends with" do
  ...
  it "I get an error message when I add someone who isn't a registered user" do
